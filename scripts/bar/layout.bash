...
# Output current layout:
    xkb-switch -p | awk -v font="$font" -v font_weight="$font_weight" '{print "<span foreground=\"#0198c6\"></span><span font_family=\""font"\"  font_weight=\""font_weight"\"> "toupper($0)"</span>"}' || sleep 1
